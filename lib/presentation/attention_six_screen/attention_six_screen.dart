...
class AttentionSixScreen extends StatelessWidget {
  AttentionSixScreen({Key? key})
      : super(
          key: key,
        );
                ...
                child: Column(
                  children: [
                    ...
                    CustomElevatedButton(
                      width: 146.h,
                      text: "Finish",
                      buttonTextStyle: CustomTextStyles.titleLargeGray2008e,
                    ),
                    Spacer(
                      flex: 72,
                    ),
