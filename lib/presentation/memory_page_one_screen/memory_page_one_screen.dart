import '../memory_page_one_screen/widgets/velvet_item_widget.dart';
...
class MemoryPageOneScreen extends StatelessWidget {
  const MemoryPageOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget _buildVelvet(BuildContext context) {
    return Padding(
      ...
      child: Wrap(
        runSpacing: 13.46.v,
        spacing: 13.46.h,
        children: List<Widget>.generate(9, (index) => VelvetItemWidget()),
      ),
    );
  }
}
